...
class AgentModel extends CommModel
{
    ...
    public $arrAddTh = array(
        ...
        'mysqlUser'     => array('label' => 'Mysql用户名', 'other' => array('required' => true, 'rangelength' => '[2, 50]', 'value' => 'Bleach_mC')),
        'mysqlPass'     => array('label' => 'Mysql密码', 'other' => array('required' => true, 'rangelength' => '[2, 50]', 'value' => '*chB20131008(v')),
