...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">loveme刘星 个人博客</a>
        </div>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-header">做点什么</li>
                        <li>
                            <a href="#">发布文章</a>
                        </li>
                        <li>
...
<div class="container content">
        ...
        <div id="slide-header" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="/Public/Home/images/a1.jpg" class="img-responsive" alt="First slide">
                ...
                <div class="item">
                    <img src="/Public/Home/images/a2.jpg" class="img-responsive" alt="Second slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                ...
                <div class="item">
                    <img src="/Public/Home/images/a3.jpg" class="img-responsive" alt="Third slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                ...
                <div class="item">
                    <img src="/Public/Home/images/a4.jpg" class="img-responsive" alt="Third slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
    ...
    <div class="topnews">
        ...
        <div class="blogs">
            <figure><img src="/Public/Home/images/03.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="/Public/Home/images/05.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="/Public/Home/images/06.jpg"></figure>
            <ul>
