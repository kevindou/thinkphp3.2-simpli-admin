...
<div class="col-md-8 f_l">
    <div class="banner">
        <div id="slide-header" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                <li data-target="#slide-header" data-slide-to="0" class="active"></li>
                <li data-target="#slide-header" data-slide-to="1"></li>
                <li data-target="#slide-header" data-slide-to="2"></li>
                <li data-target="#slide-header" data-slide-to="3"></li>
            </ol>

            <!-- 轮播（Carousel）项目 -->
            <div class="carousel-inner">
                <div class="item active">
                    <img src="./web/Public/Home/images/a1.jpg" class="img-responsive" alt="First slide">
                ...
                <div class="item">
                    <img src="./web/Public/Home/images/a2.jpg" class="img-responsive" alt="Second slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                ...
                <div class="item">
                    <img src="./web/Public/Home/images/a3.jpg" class="img-responsive" alt="Third slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                ...
                <div class="item">
                    <img src="./web/Public/Home/images/a4.jpg" class="img-responsive" alt="Third slide">
                    <div class="carousel-caption">
                        <h3>Second slide label</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
    ...
    <div class="topnews">
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/01.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/02.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/03.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/04.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/05.jpg"></figure>
            <ul>
        ...
        <div class="blogs">
            <figure><img src="./web/Public/Home/images/06.jpg"></figure>
            <ul>
...
<div class="col-md-4 f_l">
    ...
    <!--tit01 end-->
    <div class="ad300x100">
        <img src="./web/Public/Home/images/ad300x100.jpg">
    </div>
    ...
    <div class="tuwen">
        <h3>图文推荐</h3>
        <ul>
            <li><a href="/"><img src="./web/Public/Home/images/01.jpg"><b>住在手机里的朋友</b></a>
                <p><span class="tulanmu"><a href="/">手机配件</a></span><span class="tutime">2015-02-15</span></p>
            </li>
            <li><a href="/"><img src="./web/Public/Home/images/02.jpg"><b>教你怎样用欠费手机拨打电话</b></a>
                <p><span class="tulanmu"><a href="/">手机配件</a></span><span class="tutime">2015-02-15</span></p>
            </li>
            <li><a href="/" title="手机的16个惊人小秘密，据说99.999%的人都不知"><img src="./web/Public/Home/images/03.jpg"><b>手机的16个惊人小秘密，据说...</b></a>
                <p><span class="tulanmu"><a href="/">手机配件</a></span><span class="tutime">2015-02-15</span></p>
            </li>
            <li><a href="/"><img src="./web/Public/Home/images/06.jpg"><b>住在手机里的朋友</b></a>
                <p><span class="tulanmu"><a href="/">手机配件</a></span><span class="tutime">2015-02-15</span></p>
            </li>
            <li><a href="/"><img src="./web/Public/Home/images/04.jpg"><b>教你怎样用欠费手机拨打电话</b></a>
                <p><span class="tulanmu"><a href="/">手机配件</a></span><span class="tutime">2015-02-15</span></p>
            </li>
        </ul>
    </div>
    <div class="ad"> <img src="./web/Public/Home/images/03.jpg"> </div>
    <div class="links">
