...
<ul class="col-md-12 p-15 center-block">
    <?php if(is_array($articles)): foreach($articles as $key=>$value): ?><li class="p-15 m-top-5 m-a" style="border-bottom:1px solid #f2dede;">
            <a href="<?php echo U('Index/articleView', array('id' => $value['id']));?>"><span class="text-primary"><?php echo (mb_strimwidth($value["title"],0,36,"...","utf-8")); ?></span></a>
            <span class="dtime p-left-20 time pull-right"> <?php echo ($value["create_time"]); ?> </span>
            <span class="glyphicon glyphicon-star pull-right m-right-10"> <a href="<?php echo U('Index/articleView', array('id' => $value['id']));?>">编程</a> </span>
