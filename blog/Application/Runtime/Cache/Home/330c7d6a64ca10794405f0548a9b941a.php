...
<div class="container content">
    <div class="row">
        ...
        <ol class="breadcrumb m-a">
    <li><a href="/">首页</a></li>
    <li><a href="<?php echo U('Index/article');?>">文章</a></li>
    <li class="active"><?php echo (mb_strimwidth($article["title"],0,50,"...","utf-8")); ?></li>
</ol>

<ul>
    <h3 class="text-primary p-15"><?php echo ($article["title"]); ?></h3>
    <div><?php if($article['img'] != '' ): ?><img src="<?php echo ($article["img"]); ?>" class="col-md-6"/><?php endif; echo ($article["content"]); ?></div>
    <p class="autor">
        <span class="lm f_l">个人博客</span>
        <span class="dtime f_l"><?php echo ($article["create_time"]); ?></span>
        <span class="viewnum f_r">浏览（<?php echo ($article["see_num"]); ?>）</span>
        <span class="pingl f_r">评论（<?php echo ($article["comment_num"]); ?>）</span>
    </p>
</ul>
<div class="bg-info m-top-5 p-15 center-block clearfix m-a">
    <?php if(!empty($prev)): ?><span class="glyphicon glyphicon-arrow-left pull-left p-10" aria-hidden="true">上一篇：<a href="<?php echo U('Index/articleView', array('id' => $prev['id']));?>"><?php echo (mb_strimwidth($prev["title"],0,30, "...", "utf-8")); ?></a></span><?php endif; ?>
    <?php if(!empty($next)): ?><span class="glyphicon glyphicon-arrow-right pull-right p-10" aria-hidden="true">下一篇：<a href="<?php echo U('Index/articleView', array('id' => $next['id']));?>"><?php echo (mb_strimwidth($next["title"],0,30, "...", "utf-8")); ?></a></span><?php endif; ?>
</div>
        </div>
        <!--右边内容-->
