...
<div class="layer-photos-demo" id="layer-photos-demo">
    <?php if(is_array($images)): foreach($images as $key=>$value): ?><div class="col-md-4 p-15">
        <a style="background:url(<?php echo ($value["url"]); ?>)" title="<?php echo ($value["title"]); ?>" href="javascript:;">
            <img layer-src="<?php echo ($value["url"]); ?>" src="<?php echo ($value["url"]); ?>" alt="<?php echo ($value["title"]); ?>" />
        </a>
