...
<div class="container-fluid-full">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            <td width="20%">登录账号</td>
            <td><?php echo ($_SESSION['my_admin']['username']); ?></td>
        </tr>
        <tr>
            <td>注册时间</td>
            <td class="dtime"><?php echo ($_SESSION['my_admin']['create_time']); ?></td>
        </tr>
        <tr>
            <td>上次登录时间</td>
            <td class="dtime"><?php echo ($_SESSION['my_admin']['last_time']); ?></td>
        </tr>
        <tr>
            <td>上次登录IP</td>
            <td><?php echo ($_SESSION['my_admin']['last_ip']); ?></td>
        </tr>
        </tbody>
    </table>
</div>
<script type="text/javascript">var myTable; $('.dtime').each(function(){$(this).html(timeFormat(parseInt($(this).html()), "yyyy-MM-dd hh:mm:ss"))})</script>
